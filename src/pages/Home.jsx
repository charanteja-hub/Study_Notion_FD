      ...
      <div className='relative mx-auto flex flex-col w-11/12 max-w-maxContent items-center text-white justify-between gap-8'>
        ...
        <div>
            <CodeBlocks position = {"lg:flex-row"}
                ...
                ctabtn2 = { { btnText: "upstack your skills",  linkto: "/login",  active: false, } }
            ...
            <div className = "mx-auto flex w-11/12 max-w-maxContent flex-col items-center justify-between gap-8 ">
                ...
                <div className="mb-10 mt-[-100px] flex flex-col justify-between gap-7 lg:mt-20 lg:flex-row lg:gap-0">
                    ...
                    <div className = "flex flex-col items-start gap-10 lg:w-[40%]">
                        <p className='text-[16px]'> The modern TechVeda is the dictates its own terms. Today, to be a competitive specialist requires more than professional skills. </p>                   
